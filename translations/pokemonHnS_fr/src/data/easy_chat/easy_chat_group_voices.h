...
const u8 gEasyChatWord_Whoah[] = _("OOH");
const u8 gEasyChatWord_WroooaarExcl[] = _("GROOOAR");
...
const u8 gEasyChatWord_Cries[] = _("PLEURE");
...
const u8 gEasyChatWord_OiOiOi[] = _("HO HO HO");
...
const u8 gEasyChatWord_UhHuh[] = _("OUAIS");
const u8 gEasyChatWord_OhDear[] = _("OH NON");
const u8 gEasyChatWord_Arrgh[] = _("ARRGH");
const u8 gEasyChatWord_Mufufu[] = _("MUFUFU");
const u8 gEasyChatWord_Mmm[] = _("MMM");
const u8 gEasyChatWord_OhKay[] = _("D'ACCORD");
