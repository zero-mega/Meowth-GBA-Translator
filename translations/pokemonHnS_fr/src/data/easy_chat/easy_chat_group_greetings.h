...
const u8 gEasyChatWord_ByeBye[] = _("AU REVOIR");
const u8 gEasyChatWord_MeetYou[] = _("ENCHANTÉ");
const u8 gEasyChatWord_Hey[] = _("HE");
const u8 gEasyChatWord_Smell[] = _("SENT");
const u8 gEasyChatWord_Listening[] = _("A PLUS !");
const u8 gEasyChatWord_HooHah[] = _("HOURRA");
