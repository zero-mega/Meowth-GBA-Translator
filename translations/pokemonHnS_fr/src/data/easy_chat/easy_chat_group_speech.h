...
const u8 gEasyChatWord_Recommend[] = _("RECOMMANDÉ");
const u8 gEasyChatWord_Nitwit[] = _("IDIOT");
...
const u8 gEasyChatWord_EvenSo[] = _("CEPENDANT,");
...
const u8 gEasyChatWord_Joking[] = _("PLAISANTE");
const u8 gEasyChatWord_Ready[] = _("PRET");
const u8 gEasyChatWord_Something[] = _("QUELQUE");
const u8 gEasyChatWord_Somehow[] = _("QUELQUE");
