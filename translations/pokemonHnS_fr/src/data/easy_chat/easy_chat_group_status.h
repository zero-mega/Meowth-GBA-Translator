...
const u8 gEasyChatWord_Stench[] = _("PUANT");
...
const u8 gEasyChatWord_RockHead[] = _("TÊTE DE ROC");
...
const u8 gEasyChatWord_Smart[] = _("INTELLIGENCE");
...
const u8 gEasyChatWord_BattleArmor[] = _("ARMURE");
const u8 gEasyChatWord_Cute[] = _("GRACIEUX");
const u8 gEasyChatWord_Cuteness[] = _("GRÂCE");
const u8 gEasyChatWord_Sturdy[] = _("FERMETÉ");
...
const u8 gEasyChatWord_InnerFocus[] = _("ATTENTION");
const u8 gEasyChatWord_Static[] = _("STATIK");
const u8 gEasyChatWord_Type[] = _("TYPE");
const u8 gEasyChatWord_Tough[] = _("ROBUSTESSE");
...
const u8 gEasyChatWord_Electric[] = _("ORAGE");
const u8 gEasyChatWord_Forecast[] = _("METEO");
const u8 gEasyChatWord_SereneGrace[] = _("SÉRÉNITÉ");
...
const u8 gEasyChatWord_Truant[] = _("ABSENT");
...
const u8 gEasyChatWord_Shine[] = _("BRILLE");
...
const u8 gEasyChatWord_Compoundeyes[] = _("OEIL COMPOUND");
const u8 gEasyChatWord_MarvelScale[] = _("ÉCAILLE SPÉCIALE");
const u8 gEasyChatWord_WonderGuard[] = _("GARDE MYSTÈRE");
...
const u8 gEasyChatWord_ColorChange[] = _("MULTICOLORE");
const u8 gEasyChatWord_Soundproof[] = _("ANTI-BRUIT");
const u8 gEasyChatWord_EffectSpore[] = _("SPORE");
...
const u8 gEasyChatWord_MagmaArmor[] = _("MAGMAARMURE");
...
const u8 gEasyChatWord_Blaze[] = _("FLAMME");
const u8 gEasyChatWord_Pickup[] = _("RAMASSAGE");
const u8 gEasyChatWord_Pattern[] = _("MOTIF");
