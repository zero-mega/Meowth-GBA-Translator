...
const u8 gEasyChatWord_Below[] = _("DESSOUS");
const u8 gEasyChatWord_Above[] = _("DESSUS");
const u8 gEasyChatWord_Back[] = _("RETOUR");
...
const u8 gEasyChatWord_ThisIsItExcl[] = _("C'EST L'HEURE !");
...
const u8 gEasyChatWord_Where[] = _("OU");
