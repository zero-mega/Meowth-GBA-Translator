...
const u8 gEasyChatWord_WhenIWin[] = _("SI JE GAGNE");
...
const u8 gEasyChatWord_Gutsy[] = _("AUDACIEUX");
...
const u8 gEasyChatWord_GiveUp[] = _("ABANDON");
...
const u8 gEasyChatWord_Reject[] = _("REJETTE");
const u8 gEasyChatWord_Accept[] = _("ACCEPTE");
...
const u8 gEasyChatWord_Leader[] = _("CHAMPION");
