...
const u8 gEasyChatWord_Forever[] = _("TOUJOURS");
...
const u8 gEasyChatWord_Earlier[] = _("AVANT");
const u8 gEasyChatWord_Another[] = _("AUTRE");
...
const u8 gEasyChatWord_Start[] = _("DEBUT");
