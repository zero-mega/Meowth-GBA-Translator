...
const u8 gEasyChatWord_Viewing[] = _("REGARDER");
...
const u8 gEasyChatWord_Making[] = _("FABRIQUE");
...
const u8 gEasyChatWord_Ball[] = _("BOULE");
...
const u8 gEasyChatWord_Plans[] = _("PROJETS");
