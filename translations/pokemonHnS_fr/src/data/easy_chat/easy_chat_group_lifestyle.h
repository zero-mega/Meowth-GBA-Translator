...
const u8 gEasyChatWord_Bath[] = _("BAINS");
...
const u8 gEasyChatWord_Train[] = _("ENTRAINEMENT");
...
const u8 gEasyChatWord_Living[] = _("VIVANT");
const u8 gEasyChatWord_Teacher[] = _("PROF");
...
const u8 gEasyChatWord_DeptStore[] = _("GRAND MAGASIN");
...
const u8 gEasyChatWord_Study[] = _("ETUDES");
...
const u8 gEasyChatWord_Rental[] = _("LOCATION");
