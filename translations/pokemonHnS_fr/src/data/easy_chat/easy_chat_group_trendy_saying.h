...
const u8 gEasyChatWord_HipAnd[] = _("À LA MODE");
const u8 gEasyChatWord_Shake[] = _("SECOUE");
const u8 gEasyChatWord_Shady[] = _("LOUCHE");
const u8 gEasyChatWord_Upbeat[] = _("OPTIMISTE");
const u8 gEasyChatWord_Modern[] = _("MODERNE");
const u8 gEasyChatWord_SmellYa[] = _("À PLUS");
const u8 gEasyChatWord_Bang[] = _("BOUM");
const u8 gEasyChatWord_Knockout[] = _("SACRIPANT");
const u8 gEasyChatWord_Hassle[] = _("GALÈRE");
const u8 gEasyChatWord_Winner[] = _("VAINQUEUR");
const u8 gEasyChatWord_Fever[] = _("FIEVRE");
const u8 gEasyChatWord_Wannabe[] = _("IMITATEUR");
const u8 gEasyChatWord_Baby[] = _("BEBE");
const u8 gEasyChatWord_Heart[] = _("COEUR");
