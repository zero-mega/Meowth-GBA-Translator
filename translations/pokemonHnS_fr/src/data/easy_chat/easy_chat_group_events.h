...
const u8 gEasyChatWord_StayAtHome[] = _("À LA MAISON");
...
const u8 gEasyChatWord_Stage[] = _("SCENE");
const u8 gEasyChatWord_HallOfFame[] = _("PANTHÉON");
const u8 gEasyChatWord_Evolution[] = _("EVOLUTION");
const u8 gEasyChatWord_Hyper[] = _("SUPER");
const u8 gEasyChatWord_BattleTower[] = _("TOUR DE COMBAT");
...
const u8 gEasyChatWord_Blend[] = _("MELANGE");
...
const u8 gEasyChatWord_Crush[] = _("ECRASANT");
