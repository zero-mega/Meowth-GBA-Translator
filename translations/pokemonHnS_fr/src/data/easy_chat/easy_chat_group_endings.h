...
const u8 gEasyChatWord_Those[] = _("CES");
const u8 gEasyChatWord_Isnt[] = _("N'EST");
const u8 gEasyChatWord_Wont[] = _("NE VEUT");
const u8 gEasyChatWord_Cant[] = _("NE PEUT");
...
const u8 gEasyChatWord_Wasnt[] = _("N'ÉTAIT");
const u8 gEasyChatWord_Werent[] = _("N'ÉTAIENT");
const u8 gEasyChatWord_Have[] = _("AVOIR");
const u8 gEasyChatWord_Havent[] = _("N'ONT");
const u8 gEasyChatWord_A[] = _("A");
const u8 gEasyChatWord_An[] = _("UNE");
const u8 gEasyChatWord_Not[] = _("PAS");
const u8 gEasyChatWord_There[] = _("LA");
...
const u8 gEasyChatWord_Did[] = _("FAIT");
const u8 gEasyChatWord_Didnt[] = _("N'A PAS");
const u8 gEasyChatWord_Doesnt[] = _("NE PEUT");
