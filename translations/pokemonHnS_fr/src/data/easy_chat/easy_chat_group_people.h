...
const u8 gEasyChatWord_Yours[] = _("TIEN");
...
const u8 gEasyChatWord_Babe[] = _("CHERI");
...
const u8 gEasyChatWord_Arent[] = _("NE SONT");
const u8 gEasyChatWord_Siblings[] = _("FRÈRES");
...
const u8 gEasyChatWord_ToMe[] = _("A MOI");
...
const u8 gEasyChatWord_Whose[] = _("A QUI");
...
const u8 gEasyChatWord_Hers[] = _("SIENNE");
const u8 gEasyChatWord_SheIs[] = _("C'EST ELLE");
