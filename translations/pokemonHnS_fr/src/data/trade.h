...
static const u8 sText_SpaceMove[] = _(" ATTAQUE"); // unused
...
static const u8 sText_IsThisTradeOkay[] = _("Cet échange te convient ?");
static const u8 sText_Cancel[] = _("ANNULER");
static const u8 sText_ChooseAPkmn[] = _("Choisis un POKéMON.");
static const u8 sText_Summary[] = _("RÉSUMÉ");
static const u8 sText_Trade[] = _("ECHANGE");
static const u8 sText_CancelTrade[] = _("Annuler l'échange ?");
static const u8 sJPText_PressBButtonToQuit[] = _("Bボタン　で　もどります");
static const u8 sText_Summary2[] = _("RÉSUMÉ");
static const u8 sText_Trade2[] = _("ECHANGE");
static const u8 sText_CommunicationStandby[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Communication en attente…\nVeuillez patienter.");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}L'échange a\nété annulé.");
static const u8 sText_OnlyPkmnForBattle[] = _("C'est ton seul POKéMON\npour combattre.");
static const u8 sText_WaitingForYourFriend[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}En attente que ton ami\ntermine…");
static const u8 sText_YourFriendWantsToTrade[] = _("Ton ami veut\néchanger des POKéMON.");
