const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_MEW] =
    {
        .categoryName = _("NOUVELLE ESPÈCE"),
        .height = 4,
        .weight = 40,
    ...
    {
        .categoryName = _("GROSSE MÂCHOIRE"),
        .height = 6,
        .weight = 95,
