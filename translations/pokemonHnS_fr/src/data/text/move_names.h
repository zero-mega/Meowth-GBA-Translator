const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_NIGHT_SHADE] = _("OMBRE NOCTUR"),
    [MOVE_MIMIC] = _("COPIE"),
    ...
    [MOVE_DESTINY_BOND] = _("LIEN DU DEST"),
    ...
    [MOVE_STEEL_WING] = _("AILES D’ACIE"),
    ...
    [MOVE_DRAGON_BREATH] = _("DRACO-SOUFFL"),
    ...
    [MOVE_HIDDEN_POWER] = _("PUISSANCE CA"),
    ...
    [MOVE_EXTREME_SPEED] = _("VITESSE EXTR"),
    [MOVE_ANCIENT_POWER] = _("POUVOIR ANTI"),
    ...
    [MOVE_POISON_FANG] = _("CROCHET VENI"),
    [MOVE_CRUSH_CLAW] = _("ÉCLATE GRIFF"),
    ...
    [MOVE_COSMIC_POWER] = _("FORCE COSMIQ"),
    ...
    [MOVE_MAGICAL_LEAF] = _("FEUILLE MAGI"),
    ...
    [MOVE_DOOM_DESIRE] = _("VOEU DESTRUC"),
