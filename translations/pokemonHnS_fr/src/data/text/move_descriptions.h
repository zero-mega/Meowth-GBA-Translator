...
static const u8 sPoisonStingDescription[] = _(
    "Une attaque toxique avec des épines,\n"
    "etc., qui peut empoisonner.");

static const u8 sTwineedleDescription[] = _(
    "Les dards des pattes avant\n"
    "piquent l'ennemi deux fois.");

static const u8 sPinMissileDescription[] = _(
    "Des épingles acérées frappent\n"
    "l'ennemi 2 à 5 fois.");

static const u8 sLeerDescription[] = _(
    "Effraie l'ennemi d'un regard\n"
    "pour baisser la DEFENSE.");

static const u8 sBiteDescription[] = _(
    "Mord avec des crocs vicieux.\n"
    "Peut apeurer l'ennemi.");

static const u8 sGrowlDescription[] = _(
    "Grogne gentiment pour réduire\n"
    "l'ATTAQUE de l'ennemi.");

static const u8 sRoarDescription[] = _(
    "Fait fuir l'ennemi pour mettre\n"
    "fin au combat.");

static const u8 sSingDescription[] = _(
    "Une chanson apaisante endort\n"
    "l'ennemi profondément.");

static const u8 sSupersonicDescription[] = _(
    "Émet d'étranges ondes sonores\n"
    "qui peuvent confondre l'ennemi.");

static const u8 sSonicBoomDescription[] = _(
    "Lance des ondes de choc qui\n"
    "infligent toujours 20 PV de dégâts.");

static const u8 sDisableDescription[] = _(
    "Désactive psychiquement une des\n"
    "capacités ennemies.");

static const u8 sAcidDescription[] = _(
    "Projette un acide corrosif.\n"
    "Peut baisser la DÉFENSE.");

static const u8 sEmberDescription[] = _(
    "Une faible attaque de feu qui peut\n"
    "brûler.");

static const u8 sFlamethrowerDescription[] = _(
    "Une puissante attaque de feu\n"
    "qui peut brûler l'ennemi.");

static const u8 sMistDescription[] = _(
    "Crée un brouillard qui empêche\n"
    "la baisse des stats.");

static const u8 sWaterGunDescription[] = _(
    "Projette de l'eau pour attaquer\n"
    "l'ennemi.");

static const u8 sHydroPumpDescription[] = _(
    "Projette de l'eau à haute pression\n"
    "pour frapper l'ennemi.");

static const u8 sSurfDescription[] = _(
    "Crée une énorme vague, puis\n"
    "la fait s'abattre sur l'ennemi.");

static const u8 sIceBeamDescription[] = _(
    "Projette un rayon de glace\n"
    "sur l'ennemi qui peut le geler.");

static const u8 sBlizzardDescription[] = _(
    "Frappe l'ennemi avec une tempête\n"
    "de glace qui peut le geler.");

static const u8 sPsybeamDescription[] = _(
    "Projette un rayon bizarre qui\n"
    "peut troubler l'ennemi.");

static const u8 sBubbleBeamDescription[] = _(
    "Projette des bulles avec force\n"
    "qui peuvent baisser la VITESSE.");

static const u8 sAuroraBeamDescription[] = _(
    "Tire un rayon arc-en-ciel\n"
    "qui peut baisser l'ATTAQUE.");
...
static const u8 sDrillPeckDescription[] = _(
    "Une attaque en vrille avec\n"
    "le bec en guise de foret.");

static const u8 sSubmissionDescription[] = _(
    "Un coup corps qui blesse\n"
    "aussi le lanceur.");

static const u8 sLowKickDescription[] = _(
    "Un coup de pied qui inflige plus\n"
    "de dégâts aux ennemis lourds.");

static const u8 sCounterDescription[] = _(
    "Riposte à toute attaque physique\n"
    "avec le double de puissance.");

static const u8 sSeismicTossDescription[] = _(
    "Inflige des dégâts\n"
    "égaux au niveau du lanceur.");

static const u8 sStrengthDescription[] = _(
    "Accumule une énorme puissance,\n"
    "puis écrase l'ennemi.");

static const u8 sAbsorbDescription[] = _(
    "Une attaque qui absorbe\n"
...
static const u8 sStringShotDescription[] = _(
    "Lie l'ennemi avec de la ficelle\n"
    "pour réduire sa VITESSE.");

static const u8 sDragonRageDescription[] = _(
    "Lance des ondes de choc qui\n"
    "infligent toujours 40 PV de dégâts.");

static const u8 sFireSpinDescription[] = _(
    "Emprisonne l'ennemi dans un cercle\n"
    "de feu pendant 2 à 5 tours.");

static const u8 sThunderShockDescription[] = _(
    "Une attaque électrique qui\n"
    "peut paralyser l'ennemi.");

static const u8 sThunderboltDescription[] = _(
    "Une forte attaque électrique\n"
    "qui peut paralyser l'ennemi.");
...
static const u8 sRageDescription[] = _(
    "Augmente l'ATTAQUE du lanceur\n"
    "à chaque coup reçu.");

static const u8 sTeleportDescription[] = _(
    "Une attaque psychique pour fuir\n"
    "le combat instantanément.");
...
static const u8 sMimicDescription[] = _(
    "Copie une attaque utilisée par\n"
    "l'ennemi pendant un combat.");

static const u8 sScreechDescription[] = _(
    "Émet un cri strident pour baisser\n"
    "fortement la DÉFENSE de l'ennemi.");

static const u8 sDoubleTeamDescription[] = _(
    "Crée des copies illusoires pour\n"
    "augmenter l'esquive.");
...
static const u8 sWithdrawDescription[] = _(
    "Rentre dans sa coquille dure\n"
    "pour augmenter sa DÉFENSE.");

static const u8 sDefenseCurlDescription[] = _(
    "Le lanceur s'enroule pour cacher\n"
    "ses faiblesses et monter la DEFENSE.");

static const u8 sBarrierDescription[] = _(
    "Crée une barrière qui\n"
    "augmente fortement la DEFENSE.");

static const u8 sLightScreenDescription[] = _(
    "Crée un mur de lumière qui\n"
    "réduit les dégâts d'ATQ. SPÉ.");

static const u8 sHazeDescription[] = _(
    "Crée une brume noire qui\n"
    "élimine tous les changements de stats.");

static const u8 sReflectDescription[] = _(
    "Crée un mur de lumière qui\n"
    "affaiblit les attaques physiques.");

static const u8 sFocusEnergyDescription[] = _(
    "Concentre l'énergie pour augmenter\n"
    "le taux de critique.");

static const u8 sBideDescription[] = _(
    "Encaisse les attaques pendant 2\n"
    "tours pour riposter double.");

static const u8 sMetronomeDescription[] = _(
    "Agite un doigt pour utiliser une\n"
...
static const u8 sLickDescription[] = _(
    "Lèche avec une longue langue pour\n"
    "blesser. Peut aussi paralyser.");

static const u8 sSmogDescription[] = _(
    "Une attaque de gaz d'échappement\n"
    "qui peut aussi empoisonner.");

static const u8 sSludgeDescription[] = _(
    "De la boue est lancée pour infliger\n"
    "des dégâts. Peut aussi empoisonner.");

static const u8 sBoneClubDescription[] = _(
    "Frappe l'ennemi avec un os.\n"
    "Peut apeurer l'ennemi.");

static const u8 sFireBlastDescription[] = _(
    "Incinère tout ce qu'il touche.\n"
    "Peut provoquer une brûlure.");

static const u8 sWaterfallDescription[] = _(
    "Charge l'ennemi à toute vitesse\n"
    "pour escalader les cascades.");

static const u8 sClampDescription[] = _(
    "Piège et serre l'ennemi\n"
    "pendant 2 à 5 tours.");

static const u8 sSwiftDescription[] = _(
    "Projette des rayons en forme\n"
    "d'étoile qui ne ratent jamais.");

static const u8 sSkullBashDescription[] = _(
    "Rentre la tête, puis attaque\n"
    "au tour suivant.");

static const u8 sSpikeCannonDescription[] = _(
    "Lance des pics acérés qui\n"
    "frappent de 2 à 5 fois.");

static const u8 sConstrictDescription[] = _(
    "Serre pour infliger de la douleur.\n"
    "Peut baisser la VITESSE.");

static const u8 sAmnesiaDescription[] = _(
    "Oublie quelque chose\n"
    "et monte fortement la DÉF. SPÉ.");
...
static const u8 sHiJumpKickDescription[] = _(
    "Un coup de genou sauté. S'il\n"
    "échoue, l'utilisateur est blessé.");

static const u8 sGlareDescription[] = _(
    "Effraie et intimide\n"
    "l'ennemi et le paralyse.");

static const u8 sDreamEaterDescription[] = _(
    "Prend la moitié des dégâts\n"
    "infligés à un ennemi endormi.");

static const u8 sPoisonGasDescription[] = _(
    "Enveloppe l'ennemi d'un gaz toxique\n"
    "qui peut l'empoisonner.");

static const u8 sBarrageDescription[] = _(
    "Lance des objets ronds sur\n"
    "l'ennemi 2 à 5 fois.");

static const u8 sLeechLifeDescription[] = _(
    "Une attaque qui vole la moitié\n"
    "des dégâts infligés.");

static const u8 sLovelyKissDescription[] = _(
    "Exige un baiser avec une grimace\n"
    "qui endort.");

static const u8 sSkyAttackDescription[] = _(
    "Repère les points faibles,\n"
    "puis frappe au tour suivant.");

static const u8 sTransformDescription[] = _(
    "Altère les cellules de l'utilisateur\n"
    "pour copier l'ennemi.");

static const u8 sBubbleDescription[] = _(
    "Une attaque utilisant des bulles.\n"
    "Peut baisser la VITESSE de l'ennemi.");

static const u8 sDizzyPunchDescription[] = _(
    "Un coup de poing rythmé qui peut\n"
    "confondre l'ennemi.");
...
static const u8 sFlashDescription[] = _(
    "Libère un puissant éclair de\n"
    "lumière qui baisse la précision.");

static const u8 sPsywaveDescription[] = _(
    "Attaque avec une onde\n"
    "psychique d'intensité variable.");

static const u8 sSplashDescription[] = _(
    "Ce n'est qu'un éclaboussage…\n"
    "N'a aucun effet.");

static const u8 sAcidArmorDescription[] = _(
    "Liquéfie le corps de l'utilisateur\n"
    "pour monter fortement la DÉFENSE.");

static const u8 sCrabhammerDescription[] = _(
    "Frappe avec une pince.\n"
    "A un fort taux de critique.");
...
static const u8 sStruggleDescription[] = _(
    "Utilisé seulement si tous les PP sont épuisés.\n"
    "Blesse aussi un peu l'utilisateur.");

static const u8 sSketchDescription[] = _(
    "Copie la dernière capacité de\n"
    "l'ennemi de façon permanente.");

static const u8 sTripleKickDescription[] = _(
    "Donne trois coups de pied à l'ennemi\n"
    "d'affilée avec une intensité croissante.");

static const u8 sThiefDescription[] = _(
    "En attaquant, peut voler\n"
    "l'objet tenu de l'ennemi.");

static const u8 sSpiderWebDescription[] = _(
    "Capture l'ennemi pour l'empêcher\n"
    "de fuir ou de changer.");

static const u8 sMindReaderDescription[] = _(
    "Devine l'action de l'ennemi pour\n"
    "garantir que la prochaine capacité touche.");

static const u8 sNightmareDescription[] = _(
    "Inflige 1/4 des dégâts à un ennemi\n"
    "endormi à chaque tour.");
...
static const u8 sSnoreDescription[] = _(
    "Une attaque bruyante utilisable\n"
    "uniquement pendant le sommeil.");

static const u8 sCurseDescription[] = _(
    "Une capacité qui fonctionne\n"
    "différemment sur les SPECTRES.");

static const u8 sFlailDescription[] = _(
    "Inflige plus de dégâts quand\n"
    "les PV du lanceur sont bas.");

static const u8 sConversion2Description[] = _(
    "Rend l'utilisateur résistant\n"
    "au type de la dernière attaque.");

static const u8 sAeroblastDescription[] = _(
    "Lance une rafale aspirée.\n"
    "Taux de critiques élevé.");

static const u8 sCottonSporeDescription[] = _(
    "Des spores s'accrochent à l'ennemi\n"
    "et baissent fortement la VITESSE.");
...
static const u8 sSpiteDescription[] = _(
    "Réduit avec rancune les PP\n"
    "de la dernière capacité ennemie.");

static const u8 sPowderSnowDescription[] = _(
    "Projette une bourrasque neigeuse\n"
    "sur l'ennemi. Peut geler.");

static const u8 sProtectDescription[] = _(
    "Esquive l'attaque, mais peut échouer\n"
    "si utilisé en succession.");

static const u8 sMachPunchDescription[] = _(
    "Un coup de poing lancé à une vitesse\n"
    "fou pour frapper en premier.");

static const u8 sScaryFaceDescription[] = _(
    "Effraie avec une grimace\n"
    "pour baisser fortement la VITESSE.");

static const u8 sFaintAttackDescription[] = _(
    "Attire l'ennemi puis frappe\n"
    "sans jamais rater.");

static const u8 sSweetKissDescription[] = _(
    "Demande un baiser avec un regard mignon.\n"
    "Peut rendre confus.");

static const u8 sBellyDrumDescription[] = _(
    "Maximise l'ATTAQUE en\n"
    "sacrifiant les PV.");
...
static const u8 sMudSlapDescription[] = _(
    "Lance de la boue au visage de l'ennemi\n"
    "pour baisser sa précision.");

static const u8 sOctazookaDescription[] = _(
    "Projette une boule d'encre pour\n"
    "infliger des dégâts et baisser la précision.");

static const u8 sSpikesDescription[] = _(
    "Pose des pics qui blessent\n"
    "l'ennemi en entrant.");

static const u8 sZapCannonDescription[] = _(
    "Puissant et sûr de paralyser,\n"
    "mais imprécis.");

static const u8 sForesightDescription[] = _(
    "Annule les efforts de l'ennemi\n"
    "pour augmenter son esquive.");

static const u8 sDestinyBondDescription[] = _(
    "Si l'utilisateur est K.O.,\n"
    "l'ennemi est aussi mis K.O.");

static const u8 sPerishSongDescription[] = _(
    "Tout POKéMON entendant cette\n"
    "chanson s'évanouit en 3 tours.");

static const u8 sIcyWindDescription[] = _(
    "Une attaque glaciale qui\n"
    "baisse la VITESSE de l'ennemi.");
...
static const u8 sLockOnDescription[] = _(
    "Verrouille l'ennemi pour que\n"
    "la prochaine attaque touche.");
...
static const u8 sEndureDescription[] = _(
    "Encaisse toute attaque pendant\n"
    "1 tour, en gardant au moins 1 PV.");
...
static const u8 sSteelWingDescription[] = _(
    "Frappe l'ennemi avec des ailes\n"
    "dures déployées.");

static const u8 sMeanLookDescription[] = _(
    "Fixe l'ennemi d'un regard noir\n"
    "qui empêche la fuite.");

static const u8 sAttractDescription[] = _(
    "Rend le sexe opposé moins\n"
    "enclin à attaquer.");

static const u8 sSleepTalkDescription[] = _(
    "Utilise une capacité au hasard\n"
    "en dormant.");

static const u8 sHealBellDescription[] = _(
    "Carillonne doucement pour soigner\n"
    "tous les problèmes de statut.");

static const u8 sReturnDescription[] = _(
    "Une attaque qui augmente\n"
    "en puissance avec l'amitié.");

static const u8 sPresentDescription[] = _(
    "Un cadeau sous forme de\n"
    "bombe. Peut restaurer des PV.");

static const u8 sFrustrationDescription[] = _(
    "Une attaque plus puissante\n"
    "si le DRESSEUR est détesté.");

static const u8 sSafeguardDescription[] = _(
    "Une force mystique empêche\n"
    "tous les problèmes de statut.");

static const u8 sPainSplitDescription[] = _(
    "Additionne les PV de l'utilisateur et de l'ennemi,\n"
    "puis les partage également.");

static const u8 sSacredFireDescription[] = _(
    "Une attaque de feu mystique\n"
    "qui peut brûler l'ennemi.");

static const u8 sMagnitudeDescription[] = _(
    "Une attaque sismique\n"
    "d'intensité aléatoire.");

static const u8 sDynamicPunchDescription[] = _(
    "Puissant et sûr de rendre confus,\n"
    "mais imprécis.");

static const u8 sMegahornDescription[] = _(
    "Une charge brutale avec\n"
    "des cornes en avant.");

static const u8 sDragonBreathDescription[] = _(
    "Frappe l'ennemi avec un\n"
    "souffle incroyable.");

static const u8 sBatonPassDescription[] = _(
    "Remplace l'utilisateur tout en\n"
    "gardant les effets actifs.");

static const u8 sEncoreDescription[] = _(
    "Force l'ennemi à répéter sa\n"
    "dernière capacité pendant 2 à 6 tours.");

static const u8 sPursuitDescription[] = _(
    "Inflige de gros dégâts si utilisé\n"
    "sur un ennemi qui se retire.");

static const u8 sRapidSpinDescription[] = _(
    "Fait tourner le corps à grande\n"
    "vitesse pour frapper l'ennemi.");

static const u8 sSweetScentDescription[] = _(
    "Séduit l'ennemi pour réduire\n"
    "sa capacité d'esquive.");

static const u8 sIronTailDescription[] = _(
    "Attaque avec une queue dure\n"
    "comme la pierre. Peut baisser la DEFENSE.");

static const u8 sMetalClawDescription[] = _(
    "Une attaque de griffe qui peut\n"
    "augmenter l'ATTAQUE du lanceur.");

static const u8 sVitalThrowDescription[] = _(
    "Fait agir le lanceur en dernier,\n"
    "mais l'attaque ne rate jamais.");

static const u8 sMorningSunDescription[] = _(
    "Restaure des PV. La quantité\n"
    "dépend de la météo.");
...
static const u8 sAssistDescription[] = _(
    "Attaque au hasard avec\n"
    "une des capacités du partenaire.");

static const u8 sIngrainDescription[] = _(
    "Plante des racines qui restaurent les PV.\n"
    "L'utilisateur ne peut pas changer.");

static const u8 sSuperpowerDescription[] = _(
    "Augmente fortement la force,\n"
    "mais baisse les stats.");

static const u8 sMagicCoatDescription[] = _(
    "Renvoie les effets spéciaux\n"
    "à l'attaquant.");

static const u8 sRecycleDescription[] = _(
    "Recycle un objet utilisé pour\n"
    "une utilisation de plus.");

static const u8 sRevengeDescription[] = _(
    "Une attaque qui gagne en puissance\n"
    "si blessé par l'ennemi.");

static const u8 sBrickBreakDescription[] = _(
    "Détruit les barrières comme\n"
    "PROTECTION et inflige des dégâts.");

static const u8 sYawnDescription[] = _(
    "Fait bâiller l'ennemi,\n"
    "puis l'endort au tour suivant.");

static const u8 sKnockOffDescription[] = _(
    "Fait tomber l'objet tenu de l'ennemi\n"
    "pour empêcher son utilisation.");

static const u8 sEndeavorDescription[] = _(
    "Gagne en puissance si les PV\n"
    "de l'utilisateur sont inférieurs à ceux de l'ennemi.");

static const u8 sEruptionDescription[] = _(
    "Plus les PV du lanceur sont élevés,\n"
    "plus les dégâts sont importants.");

static const u8 sSkillSwapDescription[] = _(
    "Le lanceur échange son talent\n"
    "avec celui de la cible.");

static const u8 sImprisonDescription[] = _(
    "Empêche l'ennemi d'utiliser\n"
    "les capacités connues du lanceur.");

static const u8 sRefreshDescription[] = _(
    "Soigne l'empoisonnement, la paralysie\n"
    "ou une brûlure.");

static const u8 sGrudgeDescription[] = _(
    "Si l'utilisateur est K.O., efface\n"
    "tous les PP de la dernière capacité de l'ennemi.");

static const u8 sSnatchDescription[] = _(
    "Vole les effets de l'attaque\n"
    "que la cible utilisera ensuite.");

static const u8 sSecretPowerDescription[] = _(
    "Une attaque dont les effets\n"
    "varient selon le lieu.");

static const u8 sDiveDescription[] = _(
    "Plonge sous l'eau au premier tour\n"
    "et frappe au tour suivant.");

static const u8 sArmThrustDescription[] = _(
    "Coups de poing à bras tendus qui\n"
    "frappent l'ennemi de 2 à 5 fois.");
...
static const u8 sTailGlowDescription[] = _(
    "Émet une lumière qui augmente\n"
    "fortement l'ATQ. SPÉ.");

static const u8 sLusterPurgeDescription[] = _(
    "Attaque avec un éclair de lumière.\n"
    "Peut baisser la DÉF. SPÉ.");

static const u8 sMistBallDescription[] = _(
    "Attaque en déchargeant\n"
    "de duvet. Peut baisser l'ATQ. SPÉ.");

static const u8 sFeatherDanceDescription[] = _(
    "Enveloppe l'ennemi de duvet\n"
    "pour baisser fortement l'ATTAQUE.");

static const u8 sTeeterDanceDescription[] = _(
    "Confond tous les POKéMON\n"
    "sur le terrain.");

static const u8 sBlazeKickDescription[] = _(
    "Un coup de pied au taux de critique\n"
    "élevé. Peut brûler l'ennemi.");

static const u8 sMudSportDescription[] = _(
    "Recouvre l'utilisateur de boue pour\n"
    "augmenter la résistance électrique.");

static const u8 sIceBallDescription[] = _(
    "Attaque de 5 tours qui gagne\n"
    "en puissance à chaque coup.");

static const u8 sNeedleArmDescription[] = _(
    "Attaque avec des bras épineux.\n"
    "Peut apeurer l'ennemi.");
...
static const u8 sHyperVoiceDescription[] = _(
    "Une attaque bruyante qui utilise\n"
    "des ondes sonores pour blesser.");

static const u8 sPoisonFangDescription[] = _(
    "Une attaque aux crocs acérés.\n"
    "Peut empoisonner gravement l'ennemi.");

static const u8 sCrushClawDescription[] = _(
    "Déchire l'ennemi avec des\n"
    "griffes acérées. Peut baisser la DÉFENSE.");
...
static const u8 sMeteorMashDescription[] = _(
    "Lance un coup de poing météore.\n"
    "Peut augmenter l'ATTAQUE.");

static const u8 sAstonishDescription[] = _(
    "Une attaque qui peut apeurer\n"
    "l'ennemi.");

static const u8 sWeatherBallDescription[] = _(
    "Le type et la puissance de l'attaque\n"
    "changent avec la météo.");

static const u8 sAromatherapyDescription[] = _(
    "Soigne tous les problèmes de statut\n"
    "avec un parfum apaisant.");

static const u8 sFakeTearsDescription[] = _(
    "Feint de pleurer pour baisser\n"
    "fortement la DÉF. SPÉ de l'ennemi.");

static const u8 sAirCutterDescription[] = _(
    "Tranche avec un vent tranchant.\n"
    "Taux de critiques élevé.");

static const u8 sOverheatDescription[] = _(
    "Permet une attaque à pleine puissance,\n"
    "mais baisse fortement l'ATQ. SPÉ.");
...
static const u8 sIcicleSpearDescription[] = _(
    "Attaque l'ennemi en tirant\n"
    "2 à 5 glaçons d'affilée.");

static const u8 sIronDefenseDescription[] = _(
    "Durcit la surface du corps\n"
    "pour monter fortement la DÉFENSE.");

static const u8 sBlockDescription[] = _(
    "Bloque le passage de l'ennemi\n"
    "pour l'empêcher de fuir.");

static const u8 sHowlDescription[] = _(
    "Hurle pour remonter le moral\n"
    "et augmenter l'ATTAQUE.");

static const u8 sDragonClawDescription[] = _(
    "Griffe l'ennemi avec des\n"
    "griffes acérées.");
...
static const u8 sBulkUpDescription[] = _(
    "Gonfle le corps pour augmenter\n"
    "l'ATTAQUE et la DÉFENSE.");

static const u8 sBounceDescription[] = _(
    "Rebondit en haut, puis redescend\n"
    "au tour suivant. Peut paralyser.");

static const u8 sMudShotDescription[] = _(
    "Lance de la boue sur l'ennemi\n"
    "et réduit la VITESSE.");

static const u8 sPoisonTailDescription[] = _(
    "A un taux de critique élevé.\n"
    "Peut aussi empoisonner.");

static const u8 sCovetDescription[] = _(
    "Mendie gentiment pour obtenir\n"
    "un objet tenu par l'ennemi.");

static const u8 sVoltTackleDescription[] = _(
    "Un plaquage risqué qui\n"
    "blessse légèrement l'utilisateur.");

static const u8 sMagicalLeafDescription[] = _(
    "Attaque avec une étrange feuille\n"
    "qui ne peut pas être esquivée.");

static const u8 sWaterSportDescription[] = _(
    "L'utilisateur est trempé pour\n"
    "augmenter sa résistance au feu.");

static const u8 sCalmMindDescription[] = _(
    "Augmente l'ATQ. SPÉ et la DÉF. SPÉ\n"
    "en concentrant l'esprit.");

static const u8 sLeafBladeDescription[] = _(
    "Tranche avec une feuille tranchante.\n"
    "Taux de critiques élevé.");

static const u8 sDragonDanceDescription[] = _(
    "Une danse mystique qui augmente\n"
    "l'ATTAQUE et la VITESSE.");

static const u8 sRockBlastDescription[] = _(
    "Lance des rochers sur l'ennemi\n"
...
static const u8 sWaterPulseDescription[] = _(
    ...
    "ultrasoniques. Peut confondre l'ennemi.");

static const u8 sDoomDesireDescription[] = _(
    "Invoque un soleil intense pour\n"
...
static const u8 sDarkPulseDescription[] = _(
    "Attaque avec une horrible\n"
    "aura. Peut faire sursauter.");

static const u8 sPsychoCutDescription[] = _(
    "Déchire avec des lames psychiques.\n"
    "Taux de critiques élevé.");

static const u8 sPowerGemDescription[] = _(
    "Attaque avec des rayons de lumière\n"
...
static const u8 sFlashCannonDescription[] = _(
    "Libère un éclair de lumière\n"
    "qui peut baisser la DÉF. SPÉ.");

static const u8 sShadowClawDescription[] = _(
    "Frappe avec une griffe d'ombre.\n"
    "Taux de critiques élevé.");
...
static const u8 sBugBuzzDescription[] = _(
    "Une onde sonore qui inflige des dégâts\n"
    "et peut baisser la Déf. Spé.");

static const u8 sDragonPulseDescription[] = _(
    "Génère une onde de choc pour\n"
    "blesser l'ennemi.");

static const u8 sEarthPowerDescription[] = _(
    "Fait éclater le sol avec\n"
    "de la puissance. Peut baisser la Déf. Spé.");

static const u8 sPlayRoughDescription[] = _(
    "Joue brutalement avec l'ennemi.\n"
    "Peut baisser l'ATTAQUE.");

static const u8 sMoonblastDescription[] = _(
    "Attaque avec la puissance\n"
    "de la lune. Peut baisser l'Atq. Spé.");

static const u8 sPoisonJabDescription[] = _(
    "Une attaque perçante qui\n"
    "peut empoisonner l'ennemi.");
